...
if period=="weekly":
    ...
    fig.update_traces(line_color='#0055A4')
    ...
    fig.update_yaxes(title_font=dict(size=18, family='Courier'))
    fig.update_layout(title_font=dict(color="#EF4135", size=22))
    ...
    fig4.update_xaxes(title_font=dict(size=18, family='Courier'))
    fig4.update_yaxes(title_font=dict(size=18, family='Courier'))
    fig4.update_layout(title_font=dict(color="#EF4135", size=22))
    ...
    if reg:
        ...
        fig2.update_traces(line_color='#0055A4')
        fig2.update_xaxes(title_font=dict(size=18, family='Courier'))
        fig2.update_yaxes(title_font=dict(size=18, family='Courier'))
        fig2.update_layout(title_font=dict(color="#EF4135", size=22))
...
fig6.update_traces(marker_color='#0055A4')
fig6.update_xaxes(title_font=dict(size=18, family='Courier'))
fig6.update_yaxes(title_font=dict(size=18, family='Courier'))
fig6.update_layout(title_font=dict(color="#EF4135", size=22))
...
fig5.update_traces(marker_color='#0055A4')
fig5.update_xaxes(title_font=dict(size=18, family='Courier'))
fig5.update_yaxes(title_font=dict(size=18, family='Courier'))
fig5.update_layout(title_font=dict(color="#EF4135", size=22))
...
# original_title = '<p style="color:#EF4135; font-size: 22px;">Incidence rate of influenza per region through years</p>'
